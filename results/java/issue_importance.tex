...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (153.01, 51.03) {ConstructorCallsOverridableMethod};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (153.01, 90.00) {FormalParameterNamingConventions};
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (153.01,206.89) {UncommentedEmptyMethodBody};
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at (153.01,401.71) {JUnitAssertionsShouldIncludeMessage};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (578.16,433.62);
