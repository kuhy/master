...
** =git-contrast=
   ...
   - *TODO:* flawfinder instead of OCLint
...
*** Is there a relationship between the source code quality and the pull request acceptance?
    ...
    determined using the chi-square test. In order to perform this test, the dataset
    ...
    Moreover, the chi-square test was performed independently for each issue
...
* Conclusion
  ...
  affects PR acceptance. For each language, the chi-square test of independence
