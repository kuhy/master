...
*** ROC curves
    #+BEGIN_EXPORT latex
      \tikzFigure{results/python/}{roc_curves}{Python classification ROC}{fig:python_roc}
      \tikzFigure{results/java/}{roc_curves}{Java classification ROC}{fig:java_roc}
      \tikzFigure{results/kotlin/}{roc_curves}{Kotlin classification ROC}{fig:kotlin_roc}
      \tikzFigure{results/haskell/}{roc_curves}{Haskell classification ROC}{fig:haskell_roc}
      \tikzFigure{results/c_cpp/}{roc_curves}{C/C++ classification ROC}{fig:c_cpp_roc}
    #+END_EXPORT
** Regression metrics
   #+BEGIN_EXPORT latex
     \begin{table}[htbp]
...
*** Absolute error density
    #+BEGIN_EXPORT latex
      \tikzFigure{results/python/}{regression_absolute_error}{Python AE density}{fig:python_ae}
      \tikzFigure{results/java/}{regression_absolute_error}{Java AE density}{fig:java_ae}
      \tikzFigure{results/kotlin/}{regression_absolute_error}{Kotlin AE density}{fig:kotlin_ae}
      \tikzFigure{results/haskell/}{regression_absolute_error}{Haskell AE density}{fig:haskell_ae}
      \tikzFigure{results/c_cpp/}{regression_absolute_error}{C/C++ AE density}{fig:c_cpp_ae}
    #+END_EXPORT
