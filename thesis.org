...
** Python
   ...
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/python/stars_and_acceptance}
   }
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \inputTikz{data/python/}{pr_quality_heat_map}
   }
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/python/issues_types_and_prs}
   }
...
** Java
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/java/stars_and_acceptance}
   }
   \caption{Stars and pull request acceptance}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \inputTikz{data/java/}{pr_quality_heat_map}
   }
   \caption{Pull requests and quality}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/java/issues_types_and_prs}
   }
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/java/issue_importance}
   ...
   reason why this issue has the largest importance.  However,
   performed study indicates that presence of test code does not influence PR
   acceptance[[cite:explaratory]].

   The PCA scatter plot for Java pull requests looks as follows:
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/java/acceptance_pca}
   \caption{PCA scatter plot}
   \end{figure}
   #+END_EXPORT
...
** Kotlin
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/kotlin/stars_and_acceptance}
   }
   \caption{Stars and pull request acceptance}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \inputTikz{data/kotlin/}{pr_quality_heat_map}
   }
   \caption{Pull requests and quality}
   \end{figure}
   #+END_EXPORT
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/kotlin/issue_importance}
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/kotlin/acceptance_pca}
   \caption{PCA scatter plot}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth}{!}{%
     \input{data/kotlin/acceptance_ct}
   }
   \caption{Relation between presence of issue and PR acceptance}
   \end{figure}
   #+END_EXPORT
...
** Haskell
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/haskell/stars_and_acceptance}
   }
   \caption{Stars and pull request acceptance}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \inputTikz{data/haskell/}{pr_quality_heat_map}
   }
   \caption{Pull requests and quality}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/haskell/issues_types_and_prs}
   }
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/haskell/issue_importance}
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/haskell/acceptance_pca}
   \caption{PCA scatter plot}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth}{!}{%
     \input{data/haskell/acceptance_ct}
   }
   \caption{Relation between presence of issue and PR acceptance}
   \end{figure}
   #+END_EXPORT
...
** C/C++
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/c_cpp/stars_and_acceptance}
   }
   \caption{Stars and pull request acceptance}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \inputTikz{data/c_cpp/}{pr_quality_heat_map}
   }
   \caption{Pull requests and quality}
   \end{figure}
   #+END_EXPORT
   ...
   \begin{figure}[H]\centering
   \resizebox{\textwidth + 2cm}{!}{%
     \input{data/c_cpp/issues_types_and_prs}
   }
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/c_cpp/issue_importance}
   ...
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \input{data/c_cpp/acceptance_pca}
   \caption{PCA scatter plot}
   \end{figure}
   #+END_EXPORT
   ...
   When considering only pull requests that solely modified some source files, Cramer's V $\phi_c = 0.024$
   --- the presence of issue also have some negative impact but even smaller than in the previous test.
   #+BEGIN_EXPORT latex
   \begin{figure}[H]\centering
   \resizebox{\textwidth}{!}{%
     \input{data/c_cpp/acceptance_ct}
   }
   \caption{Relation between presence of issue and PR acceptance}
   \end{figure}
   #+END_EXPORT
   Some small impact was also discovered when the chi-square test was performed separately for
...
** TODO Programming languages and code quality impact
   - RQ5
** TODO Threads to validity
...
** Projects
   ...
   \centering
   \begingroup\footnotesize
   \input{data/java/projects_summary}
   \endgroup
   \end{table}
   #+END_EXPORT
   #+BEGIN_EXPORT latex
   ...
   \centering
   \begingroup\footnotesize
   \input{data/kotlin/projects_summary}
   \endgroup
   \end{table}
   #+END_EXPORT
   #+BEGIN_EXPORT latex
   ...
   \centering
   \begingroup\footnotesize
   \input{data/haskell/projects_summary}
   \endgroup
   \end{table}
   #+END_EXPORT
   #+BEGIN_EXPORT latex
   ...
   \centering
   \begingroup\footnotesize
   \input{data/c_cpp/projects_summary}
   \endgroup
   \end{table}
   #+END_EXPORT
** Issue categories
   ...
   \centering
   \begingroup\footnotesize
   \input{data/java/issue_types_summary}
   \endgroup
   \end{table}
   #+END_EXPORT
** Model reliability
