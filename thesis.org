...
#+LANGUAGE: en
* Introduction
  Does code quality influence the acceptance of pull requests? There are many
  factors that influence the pull requests acceptance.

  - What is the problem?
    - Integrators perceive code quality as the most important factor.
    - There is a study
  - What I did
** Problem statement
