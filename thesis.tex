...
development model (Chapter~\ref{sec:org8b32040}).
After that, the various factors that influence the pull request acceptance are
mentioned (Chapter~\ref{sec:orgc06affc}). The next part of the thesis
...
of individual pull requests (Chapter~\ref{sec:org51f0471}). Then, the used
statistical methods are introduced (Chapter~\ref{sec:org01ff516}). Furthermore,
the retrieved results are evaluated separately for each programming language
(Chapter~\ref{sec:org9c73187}). Towards the end, results are compared between
...
(Chapter~\ref{sec:org30b1ed3}). Moreover, the potential extensions of my work are
proposed.
\chapter{Code quality in pull-based development}
\label{sec:org8b32040}
...
in Table \ref{tab:orgbe4c29a}.
\begin{table}[h]
\caption{\label{tab:orgbe4c29a}Data retrieved from GitHub}
\centering
\scriptsize
\begin{tabular}{|llcc|}
\hline
...
used is determined by the file extension of the tested file (Table \ref{tab:org14209aa}).
\begin{table}[htbp]
\caption{\label{tab:org14209aa}Linters supported by \texttt{git-contrast}}
\centering
\scriptsize
\begin{tabular}{|lcll|}
\hline
