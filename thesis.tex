...
in Table~\ref{tab:org9202ed7}.
\begin{table}[h]
\caption{\label{tab:org9202ed7}Data retrieved from GitHub}
\centering
\scriptsize
\begin{tabular}{|llcc|}
\hline
...
\chapter{Evaluation}
\label{sec:org4b2003a}
This chapter is dedicated to the findings of my research. The first
five subchapters focus on individual programming languages (see Table~\ref{tab:orgc4f29fa}).
...
\begin{table}[htbp]
\caption{\label{tab:orgc4f29fa}Analyzed programming languages}
\centering
\scriptsize
\begin{tabular}{|lcll|}
\hline
...
\hline
\hline
\hyperref[sec:org5df82ce]{Python} & 20 & 9452 & 73 \%\\
\hyperref[sec:orgcd0b435]{Java} & 20 & 8887 & 73 \%\\
\hyperref[sec:orgcb25150]{Kotlin} & 20 & 7514 & 80 \%\\
\hyperref[sec:org3ddd30b]{Haskell} & 20 & 6949 & 78 \%\\
\hyperref[sec:orgb796d0f]{C/C++} & 20 & 8774 & 77 \%\\
\hline
\end{tabular}
\end{table}
\FloatBarrier
\section{Python}
\label{sec:org5df82ce}
