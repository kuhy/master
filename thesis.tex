...
in Table~\ref{tab:org13a8ded}.
\begin{table}[h]
\caption{\label{tab:org13a8ded}Data retrieved from GitHub}
\centering
\scriptsize
\begin{tabular}{|llcc|}
\hline
...
\chapter{Evaluation}
\label{sec:org350471f}
This chapter is dedicated to the findings of my research. The first
five subchapters focus on individual programming languages (see Table~\ref{tab:org78406be}).
...
\begin{table}[htbp]
\caption{\label{tab:org78406be}Analyzed programming languages}
\centering
\scriptsize
\begin{tabular}{|lcll|}
\hline
...
\hline
\hline
\hyperref[sec:org13ff330]{Python} & 20 & 9452 & 73 \%\\
\hyperref[sec:orgdd27fd9]{Java} & 20 & 8887 & 73 \%\\
\hyperref[sec:org5fa10ec]{Kotlin} & 20 & 7514 & 80 \%\\
\hyperref[sec:org99ef030]{Haskell} & 20 & 6949 & 78 \%\\
\hyperref[sec:orgf3f0e9d]{C/C++} & 20 & 8774 & 77 \%\\
\hline
\end{tabular}
\end{table}
\FloatBarrier
\section{Python}
\label{sec:org13ff330}
